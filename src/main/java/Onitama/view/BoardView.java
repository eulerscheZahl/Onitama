...
public class BoardView {
    ...
    public BoardView(Board board, GraphicEntityModule graphicEntityModule, TooltipModule tooltipModule, List<Player> players) {
        this.board = board;
        ...
        for (int x = 0; x < board.SIZE; x++) {
            for (int y = 0; y < board.SIZE; y++) {
                ...
                if (figure != null) new FigureView(figure, boardGroup, graphicEntityModule, tooltipModule);
            }
        }
